<template>
  <div class="ui teal inverted borderless top fixed menu">
    ...
    <div class="right menu">
      <router-link to="/apps" class="item" data-tooltip="Apps" data-position="bottom center">
        <i class="large th icon"></i>
      </router-link>
      <router-link to="/devices" class="item" data-tooltip="Devices" data-position="bottom center">
        <i class="large print icon"></i>
      </router-link>
      <router-link to="/details" class="item" data-tooltip="Details" data-position="bottom center">
      ...
      <router-link to="/info" class="item" data-tooltip="Info" data-position="bottom center">
